...
1. Anchor job 생성
2. **Requirement dependency** 에 의해 Anchor job으로부터 Transaction 생성
3. Transaction의 Job들이 Runqueue에 Install 됨
4. Runqueue의 맨 앞 Job이 **Ordering dependency**에 의해 실행
5. Job 이 **끝**나면, **Requirement dependency** 에 의해 Runqueue 에 Job enqueue 
